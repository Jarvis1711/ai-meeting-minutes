...
STATUSES = ["new", "processing", "validated", "deployed"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="AI Meeting Minutes",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="AI & Data",
        ENTITY_SINGULAR="Ai Meeting Insight",
        ENTITY_PLURAL="Ai Meeting Insights",
    )
